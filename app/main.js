...
/* make the resize function fire every time window is resized */
            ...
            var azamitime = ["はよー。顔洗って、しっかり保温しろよ", "今日の給食、酢の物あるじゃん…少なめに配膳させっか", "今日も下校中に絡まれた。…安心しろ、撒いてきたから", "夜更かしはほどほどにしろよ？明日の化粧ノリに響くぞ"];

            var azamiother = ["ちょっ…！そ、そういうスキンシップは、フツー結婚してからやるモンだろーが…！", "あー、ちょっとチルってたわ。何か用か？", "クソ左京のヤローがいちいちうるせぇ…なぁ、部屋替えとかねぇの？", "メイク、自分でも試すからな。スキンケアは気ぃつけてる", "ん？機嫌良さそう？…この後ケンさんが会いに来てくれっからな", "なんか…アンタと一緒にいると落ち着くな。年上のオンナに、こんなこと初めて思った", "練習台になってくれる約束だろ？新しいメイク道具、試させてくれ", "『#コスメ』で一位になってた化粧水。試供品あるけど、監督も使うか？", "志太は腐れ縁。なんつーか、アイツといると落ち着"];
            ...
            var kumontime = ["部活の朝練なくなったけど、クセでつい早起きしちゃうんだよなぁ…", "おべんとターイム！兄ちゃん、今日の昼メシ何食ってるのかな〜", "お肌のために早く寝ろって薊が…なんだっけ、白雪姫タイム？", "あれ、眠れないんすか？だったら、中庭でオレと一緒に素振りしましょうよ！"];

            var kumonother = ["万里のヤロー、ゆるさねー！", "えーっと…あんま触られっと、ぎゅーっとしたくなっちゃうんだけど…", "これっすか？宝物のサイン入りブロマイド！はぁ…兄ちゃんのランスキーは最高だ〜", "今日はテイガーズの野球中継があるんだ！チャンネルはそのままでー！", "ん？なんか用すか？", "ねぇねぇ！オレ、おっきくなったらもっと兄ちゃんに似るかな！", "お、前髪？やっぱオンザ眉毛が落ち着くっす！", "はー…かっけー…唯一無に…", "体育会系なんで、上下関係はわかってるっす！コキ使ってください！"];
            ...
            var guytime = ["監督、おはよう。…寝ぼけているのか？俺はシトロニアではないぞ", "シトロニアを見ていないだろうか？先ほどから捜しているんだが見当たらないんだ", "一日の疲れはその日のうちに取るのが最良だ。ゆっくり休むといい", "随分と夜遅くまで起きているようだな。眠れないなら香を焚いてみてはどうだろうか"];

            var guyother = ["言語設定は日本語になっている", "…前髪は、上げている方が落ち着くな", "むやみにスイッチを押してはならないと言っただろう？", "…何か話せばいいのだろうか？", "シトロニアには、よくポンコツだと言われる", "…すまない。あまり触れられることには慣れていない", "…ひよこ豆の話はやめてくれ", "…油断していると、俺にやり返されるぞ", "…ザフラ王国は、花がきれいだ"];
